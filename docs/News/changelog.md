## Metadata_Start 
## code: en
## title: Changelog v3.33 
## slug: changelog 
## seoTitle: Changelog v3.33 
## description:  
...
| Item | Description |
|---|---|
| 2571 | Implemented automatic generation of the  field based on UUID (Universal Unique Identifier) ​​in the Additional Settings tab of the credential. If the user does not inform the  when creating the credential, the system will create a unique identifier automatically. The generated value can be modified later. |
