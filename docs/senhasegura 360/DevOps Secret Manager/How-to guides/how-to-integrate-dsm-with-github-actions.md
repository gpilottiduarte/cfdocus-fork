...
3. In senhasegura, access your project's  via .
...
1. Select the workflow and the  option.
2. Choose the branch to run the workflow and click on 
3. Finally, click on  to display the result of the run.
