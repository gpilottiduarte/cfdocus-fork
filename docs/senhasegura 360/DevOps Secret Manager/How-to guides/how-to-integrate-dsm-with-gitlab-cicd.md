...
2. Add the executable, the configuration file, and, optionally, the  file to the project's repository.
3. On senhasegura, access your project's  through .
4. Register the variables needed to run the DSM CLI as described in the user guide.
5. Edit your  file in your project folder;
...
Example of a  configuration file using the DSM CLI:
...
1. Go to the  menu.
2. Click on .
3. In the next step, choose the desired branch and click  again.
4. Then go to  to view the details and results of the execution.
