...
2. Add the  executable, the configuration file, and the  file (if necessary) to the project repository.
3. Edit your  file located in the project folder.
...
Example of an  file using DSM CLI:
...
2. Select the pipeline you want and click .
3. In the next step, click .
